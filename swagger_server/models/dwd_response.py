...
from swagger_server.models.inline_response2001_timeseries import InlineResponse2001Timeseries  # noqa: F401,E501
...
class InlineResponse2001(Model):
    ...
    def __init__(self, station_id: str=None, resolution: str=None, observation_type: str=None, timeseries: List[InlineResponse2001Timeseries]=None):  # noqa: E501
        ...
        self.swagger_types = {
            ...
            'timeseries': List[InlineResponse2001Timeseries]
        }
    ...
    @property
    def timeseries(self) -> List[InlineResponse2001Timeseries]:
    ...
    @timeseries.setter
    def timeseries(self, timeseries: List[InlineResponse2001Timeseries]):
